...
import { luxuryApartment } from "../../assets/glamourassets/Luxury Apartment";
import { glamandglow } from "../../assets/glamourassets/glamandglow";
import {mehandidesigns } from "../../assets/glamourassets/mehandi";
import { mallsideLuxury } from "../../assets/glamourassets/Mallside Luxury";
import { sodnacSerenity } from "../../assets/glamourassets/Sodnac Serenity";
import { menipedi } from "../../assets/glamourassets/menipedi";
import { cleanup } from "../../assets/glamourassets/cleanupface";
import { gardenVilla } from "../../assets/glamourassets/Garden Villa Retreat";
import { modernMoka } from "../../assets/glamourassets/Modern Moka Retreat";
import { threadingface } from "../../assets/glamourassets/threading";
export const estates = [
  {
    id: `REALES001`,
    title: `ENCHANTED BRIDAL GRACE`,
    description: [
      `Experience the epitome of elegance with our Bridal Grace service at Glamour Palette. Our expert team of makeup artists and hairstylists specialize in creating breathtaking bridal looks that perfectly reflect your unique style and personality. From timeless and classic to modern and glamorous, we tailor every detail to ensure you feel radiant and confident on your special day. Trust Glamour Palette to make your bridal dreams a reality, leaving you with cherished memories and stunning photos to look back on. Let us be a part of your journey to wedded bliss, providing you with unparalleled service and artistry.`,
    ],
    price: "Rs 5K - Rs 20K",
  ...
  {
    id: `REALES002`,
    title: `ETHEREAL GLAM & GLOW`,
    description: [
      `Illuminate your natural beauty with our Glam and Glow service at Glamour Palette. Designed to enhance your features and give you a radiant, camera-ready look, this service combines expert makeup application with advanced skincare techniques. Whether you're preparing for a special event or simply want to treat yourself to a luxurious beauty session, our skilled professionals will ensure you leave feeling glamorous and glowing. At Glamour Palette, we use only the finest products to deliver a flawless finish that lasts. Let us help you shine with confidence and elegance, making every occasion a special one.`,
    ],
    price: "Rs 2K - Rs 12K",
    images: [glamandglow.img1, glamandglow.img2, glamandglow.img3, glamandglow.img4,glamandglow.img5,glamandglow.img6,glamandglow.img7, glamandglow.img8]
  },
  {
    id: `REALES003`,
    title: `CRYSTAL CLEAR CUT & CURLS`,
    description: [
      `Transform your look with our Cut and Curls service at Glamour Palette. Whether you're looking for a chic new haircut, elegant curls, or a complete hair makeover, our experienced stylists are here to bring your vision to life. We specialize in precision cuts and beautifully styled curls that complement your face shape and personal style. Using top-quality products and the latest techniques, we ensure your hair looks and feels its best. At Glamour Palette, we are dedicated to creating hairstyles that enhance your natural beauty and leave you feeling confident and refreshed. Let us craft the perfect cut and curls for your next stunning look.`,
    ],
    price: "Rs 500 - Rs 4K",
  ...
  {
    id: `REALES009`,
    title: `ARTISTIC MEHANDI DESIGNS`,
    description: [
  ...
  {
    id: `REALES0010`,
    title: `FLAWLESS FINISH THREADING
    `,
    description: [
